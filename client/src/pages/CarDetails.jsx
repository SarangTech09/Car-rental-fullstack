  ...
  return car ? (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
            ...
            <div>
              ...
              <div>
                ...
                <ul className='grid grid-cols-1 sm:grid-cols-2 gap-2'>
                  {
                    ["360° Camera", "Bluetooth Connectivity", "GPS", "Cruise Control", "Heated Seats", "Rear View Mirrior"].map((item)=> (
        ...
        onSubmit={handleSubmit} className='shadow-lg h-max sticky top-8 rounded-xl space-y-6 p-6 text-gray-500'>
