      ...
      <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          <div className='flex flex-col w-full'>
            <label>Brand</label>
            <input onChange={e=> setCar({...car, brand: e.target.value})} type="text" placeholder='e.g. BMW, Mercedes, Audi...' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.brand} />
          </div>
           <div className='flex flex-col w-full'>
            <label>Model</label>
            <input onChange={e=> setCar({...car, model: e.target.value})} type="text" placeholder='e.g. X5, E-Class, M4...' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.model} />
          </div>
        </div>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
            <div className='flex flex-col w-full'>
              <label>Year</label>
              <input onChange={e=> setCar({...car, year: e.target.value})} type="number" placeholder='2025' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.year} />
            </div>
            
             <div className='flex flex-col w-full'>
              <label>Daily Price ({currency})</label>
              <input onChange={e=> setCar({...car, pricePerDay: e.target.value})} type="number" placeholder='100' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.pricePerDay} />
            </div>
              <div className='flex flex-col w-full'> 
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
            ...
            <div className='flex flex-col w-full'>
             ...
             <div className='flex flex-col w-full'>
              ...
              <input type='number' onChange={e=> setCar({...car, seating_capacity: e.target.value})} value={car.seating_capacity} className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'>
              </input>
            </div>
          </div>
